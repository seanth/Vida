...
def get_cli():
	parser = argparse.ArgumentParser(description='Conver miniVida.xls into a Vida species yml file')
...
if __name__ == "__main__":
	...
	B7=firstSheet.cell(24,2).value
	B8=firstSheet.cell(25,2).value
	#print B7
	#print B8
	...
	B9 = firstSheet.cell(28,2).value
	A6 = firstSheet.cell(29,2).value
	#print B9
	#print A6


	#IdealSeedlingMass
	seedMass = firstSheet.cell(32,2).value
	#print seedMass

	#DensityLeaf:
	densityLeaf = firstSheet.cell(33,2).value
	#print densityLeaf

	#DensityStem:
	densityStem = firstSheet.cell(34,2).value
	#print densityStem

	#YoungsModStem:
	youngsModulusStem = firstSheet.cell(35,2).value
	#print youngsModulusStem

	#HeightLeaf:
	heightLeaf = firstSheet.cell(36,2).value
	#print heightLeaf

	#fractStem@germ:
	fractStem = firstSheet.cell(38,2).value
	#print fractStem
